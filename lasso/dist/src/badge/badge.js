 ...
 */
const badgeVariants = cva("inline-flex items-center justify-center rounded-full px-2 py-0.5 text-xs font-normal lasso:wght-normal leading-4 w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden", {
    variants: {
        variant: {
            default: "border border-transparent bg-blue-100 text-blue-700 [a&]:hover:opacity-80",
            primary: "border border-transparent bg-blue-100 text-blue-700 [a&]:hover:opacity-80",
            secondary: "border border-transparent bg-secondary legacy:bg-primary text-primary-foreground [a&]:hover:opacity-90",
            destructive: "border border-transparent bg-error-3 text-destructive [a&]:hover:opacity-90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 legacy:bg-red-600/30 legacy:text-red-800!",
            outline: "border border-border bg-white text-foreground [a&]:hover:opacity-90",
            success: "border border-transparent bg-success-4 text-success-11 legacy:text-white [a&]:hover:opacity-90 legacy:bg-green-600/30 legacy:text-green-700",
            warning: "border border-transparent bg-warning-3 text-warning-11 [a&]:hover:opacity-90 legacy:bg-warning-400/30 legacy:text-warning-600",
            info: "border border-transparent bg-blue-100 text-blue-700 legacy:bg-info-600 legacy:text-white [a&]:hover:opacity-80",
            muted: "border border-transparent bg-accent text-foreground [a&]:hover:opacity-90",
...
function Badge({ className, variant, asChild = false, ...props }) {
    ...
    return (_jsx(Comp, { "data-slot": "badge", className: cn(badgeVariants({ variant }), LEGACY_BADGE_STYLE, className), ...props }));
}
