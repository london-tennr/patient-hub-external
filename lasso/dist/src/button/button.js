 ...
 * ```
 */
const buttonVariants = cva("inline-flex items-center hover:cursor-pointer justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium lasso:wght-medium leading-5 transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive", {
    variants: {
        variant: {
            default: "bg-secondary legacy:bg-primary text-primary-foreground hover:bg-secondary/90 legacy:hover:bg-primary/90 disabled:opacity-50",
            destructive: "bg-destructive text-primary-foreground hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 disabled:opacity-50",
            outline: "border border-border bg-white text-foreground hover:bg-accent hover:text-accent-foreground disabled:opacity-50",
            secondary: "bg-brand-peat text-primary-foreground hover:bg-brand-peat/90 disabled:opacity-50",
            ghost: "bg-transparent text-foreground hover:bg-accent hover:text-accent-foreground disabled:opacity-50",
            ...
            brand: "bg-brand-primary text-primary-foreground hover:bg-brand-primary/90 disabled:bg-brand-primary/50 disabled:text-primary-foreground",
            muted: cn("bg-accent text-primary hover:bg-muted disabled:opacity-50 disabled:text-primary", "legacy:bg-secondary legacy:border-none legacy:hover:bg-secondary/90 legacy:hover:border-none"),
            "brand-ghost": "bg-brand-primary/10 hover:bg-brand-primary/20 text-brand-primary disabled:bg-brand-secondary/5 disabled:text-brand-primary/70",
            "brand-secondary-ghost": "bg-brand-secondary/10 hover:bg-brand-secondary/20 text-brand-secondary disabled:bg-brand-secondary/5 disabled:text-brand-secondary/70",
        },
        size: {
