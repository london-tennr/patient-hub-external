...
function Card({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card", className: cn("bg-card text-card-foreground flex flex-col gap-6 rounded-md border border-border py-6 shadow-sm", className), ...props }));
}
/**
...
function CardTitle({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-title", className: cn("text-base font-medium lasso:wght-medium leading-6 text-foreground", className), ...props }));
}
/**
...
function CardDescription({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-description", className: cn("text-sm font-normal lasso:wght-normal leading-5 text-muted-foreground", className), ...props }));
}
/**
