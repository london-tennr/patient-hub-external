...
function Checkbox({ className, ...props }) {
    return (_jsx(CheckboxPrimitive.Root, { "data-slot": "checkbox", className: cn("peer bg-background border-border data-[state=checked]:bg-brand-peat data-[state=checked]:text-primary-foreground data-[state=checked]:border-brand-peat focus-visible:border-brand-peat focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive size-4 shrink-0 rounded-sm border shadow-xs transition-all outline-none focus-visible:ring-[2px] disabled:cursor-not-allowed disabled:opacity-50 hover:border-border", className), ...props, children: _jsx(CheckboxPrimitive.Indicator, { "data-slot": "checkbox-indicator", className: "flex items-center justify-center text-current transition-none", children: _jsx(Check, { className: "size-3.5 text-current", weight: "light" }) }) }));
}
export { Checkbox };
