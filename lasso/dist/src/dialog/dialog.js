 ...
 */
function DialogContent({ className, children, showCloseButton = true, showOverlay = true, ...props }) {
    return (_jsxs(DialogPortal, { "data-slot": "dialog-portal", children: [showOverlay && _jsx(DialogOverlay, {}), _jsxs(DialogPrimitive.Content, { "data-slot": "dialog-content", className: cn("bg-white data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg", className), ...props, children: [children, showCloseButton && (_jsx(DialogPrimitive.Close, { "data-slot": "dialog-close", asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", className: "absolute top-2 right-2", "aria-label": "Close", children: _jsx(XIcon, { weight: "light" }) }) }))] })] }));
}
/**
