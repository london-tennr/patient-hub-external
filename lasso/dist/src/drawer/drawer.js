...
function Drawer({ direction = "right", ...props }) {
    return (_jsx(DrawerPrimitive.Root, { "data-slot": "drawer", direction: direction, ...props }));
}
/**
 ...
 */
function DrawerContent({ className, children, showingDraggingHandle = true, showOverlay = true, ...props }) {
    return (_jsxs(DrawerPortal, { "data-slot": "drawer-portal", children: [showOverlay && _jsx(DrawerOverlay, {}), _jsxs(DrawerPrimitive.Content, { "data-slot": "drawer-content", className: cn("group/drawer-content bg-background fixed z-50 flex h-auto flex-col", "data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:max-h-[80vh] data-[vaul-drawer-direction=top]:rounded-b-md data-[vaul-drawer-direction=top]:border-b data-[vaul-drawer-direction=top]:border-border", "data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-0 data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-[80vh] data-[vaul-drawer-direction=bottom]:rounded-t-md data-[vaul-drawer-direction=bottom]:border-t data-[vaul-drawer-direction=bottom]:border-border", "data-[vaul-drawer-direction=right]:inset-y-0 data-[vaul-drawer-direction=right]:right-0 data-[vaul-drawer-direction=right]:border-l data-[vaul-drawer-direction=right]:border-border data-[vaul-drawer-direction=right]:w-full data-[vaul-drawer-direction=right]:sm:max-w-xl", "data-[vaul-drawer-direction=left]:inset-y-0 data-[vaul-drawer-direction=left]:left-0 data-[vaul-drawer-direction=left]:border-r data-[vaul-drawer-direction=left]:border-border data-[vaul-drawer-direction=left]:w-full data-[vaul-drawer-direction=left]:sm:max-w-xl", className), ...props, children: [showingDraggingHandle && (_jsx("div", { className: "bg-muted mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" })), children] })] }));
}
/**
...
function DrawerHeader({ className, ...props }) {
    return (_jsx("div", { "data-slot": "drawer-header", className: cn("flex flex-col gap-2 p-4 group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center group-data-[vaul-drawer-direction=top]/drawer-content:text-center md:text-left", className), ...props }));
}
/**
...
function DrawerTitle({ className, ...props }) {
    return (_jsx(DrawerPrimitive.Title, { "data-slot": "drawer-title", className: cn("text-base font-semibold lasso:wght-semibold leading-6 text-foreground", className), ...props }));
}
/**
...
function DrawerDescription({ className, ...props }) {
    return (_jsx(DrawerPrimitive.Description, { "data-slot": "drawer-description", className: cn("text-sm font-normal lasso:wght-normal leading-5 text-muted-foreground", className), ...props }));
}
