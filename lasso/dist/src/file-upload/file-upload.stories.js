...
const meta = {
    ...
    argTypes: {
        ...
        onError: {
            ...
            description: "Callback function triggered when an error occurs during file upload",
            table: {
        ...
        hideDragAndDrop: {
            control: "boolean",
            description: "Show only a compact button instead of the full drag-and-drop area",
            table: {
        ...
        inputTypes: {
            ...
            description: "Array of accepted file types. Limits which file extensions users can upload.",
            table: {
                type: { summary: "string[]" },
                defaultValue: {
                    summary: "PDF, JPEG, PNG, TIF/TIFF, DOCX, CSV, TXT, XLSX, SVG, JSON, ZIP",
                },
...
export const CompactModeWithCustomTypes = {
    args: {
        onFilesChange: () => { },
        hideDragAndDrop: true,
