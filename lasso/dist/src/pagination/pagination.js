...
function PaginationPrevious({ className, size, ...props }) {
    return (_jsxs(PaginationLink, { "aria-label": "Go to previous page", size: "default", className: cn("gap-1 px-2.5 sm:pl-2.5", className), ...props, children: [_jsx(CaretLeft, {}), _jsx("span", { className: "hidden sm:block", children: "Previous" })] }));
}
/**
...
function PaginationNext({ className, size, ...props }) {
    return (_jsxs(PaginationLink, { "aria-label": "Go to next page", size: "default", className: cn("gap-1 px-2.5 sm:pr-2.5", className), ...props, children: [_jsx("span", { className: "hidden sm:block", children: "Next" }), _jsx(CaretRight, { weight: "light" })] }));
}
/**
...
function PaginationEllipsis({ className, ...props }) {
    return (_jsxs("span", { "aria-hidden": true, "data-slot": "pagination-ellipsis", className: cn("flex size-9 items-center justify-center", className), ...props, children: [_jsx(DotsThree, { weight: "light", className: "size-4" }), _jsx("span", { className: "sr-only", children: "More pages" })] }));
}
