 ...
 */
function Progress({ className, value, variant, ...props }) {
    return (_jsx(ProgressPrimitive.Root, { "data-slot": "progress", className: cn(progressVariants({ variant, className }), className), ...props, children: _jsx(ProgressPrimitive.Indicator, { "data-slot": "progress-indicator", className: progressIndicatorVariants({ variant, className }), style: { transform: `translateX(-${100 - (value || 0)}%)` } }) }));
}
export { Progress };
