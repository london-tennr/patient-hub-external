 ...
 */
export const Stack = ({ className, direction, align, justify, spacing, ...props }) => {
    return (_jsx("div", { className: cn(stackVariants({ direction, align, justify, spacing }), className), ...props }));
};
