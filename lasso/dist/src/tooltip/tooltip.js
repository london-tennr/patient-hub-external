 ...
 */
function TooltipContent({ className, sideOffset = 0, children, arrow = true, ...props }) {
    return (_jsx(TooltipPrimitive.Portal, { children: _jsxs(TooltipPrimitive.Content, { "data-slot": "tooltip-content", sideOffset: sideOffset, className: cn("bg-black text-primary-foreground animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-md px-3 py-1.5 text-xs font-normal lasso:wght-normal leading-4 text-balance", !arrow && "mt-2", className), ...props, children: [children, arrow && (_jsx(TooltipPrimitive.Arrow, { className: "legacy:invisible bg-black fill-black z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" }))] }) }));
}
/**
 ...
 */
const TooltipArrow = ({ className, ...props }) => (_jsx(TooltipPrimitive.Arrow, { className: cn("bg-black fill-black z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]", className), ...props }));
